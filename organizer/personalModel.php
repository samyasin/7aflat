...
class personal {
    ...
    public function fetchAll() {
        ...
        $result = $database->query("SELECT * FROM personal");
        if ($result) {
    ...
    public function fetchById($id) {
        $database = new database();
        $result = $database->query("SELECT * FROM personal where member_id = $id");
        if ($result) {
            $userSet = $database->fetch($result);
        }
        return isset($userSet) ? $userSet : FALSE;
    ...
    public function create() {
        $database = new database();
        $result = $database->query("INSERT INTO personal(username,party_date, description,video, invitation,phone,email,address,facebook,member_id, picture,party_type)"
    ...
    public function create_pic() {
        $database = new database();
        $result = $database->query("INSERT INTO personal_pic(picture,category, member_id)"
