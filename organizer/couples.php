        ...
        <section id="mainslider">
            ...
            <div class="flexslider">
                <ul class="slides">
                    ...
                    <li>
                        <div class="slide_overlay">
                            <img src="images/couples/flex_slide02.jpg" alt="">                      
                        </div>

                    </li>   
                    <li>
                        <div class="slide_overlay">
                            <img src="images/couples/flex_slide03.jpg" alt="">                      
                        </div>
                    </li>
                    <li>
                        <div class="slide_overlay">
                            <img src="images/couples/flex_slide04.jpg" alt="">                      
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <h2><?php echo $user['groom'] . " & " . $user['bride'] ?></h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                ...
                <div class="row to_animate" data-animation="fadeInUp">
                    <div class="col-sm-12 text-center">
                        <h2 class="section_header">
                            About <?php echo $user['groom'] . " and " . $user['bride'] ?>
                        </h2>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="to_animate" data-animation="fadeInLeft">
                            <div align="center">
                                <img class="img-circle profile_pic" src="<?php echo 'images/couples/' . $user['groom_picture'] . '' ?>">  
                            </div>
                            <div class="text-center">
                                <h3><?php echo $user['groom'] ?></h3>
                                <p><?php echo $user['description_groom'] ?> </p>
                    ...
                    <div class="col-sm-6">
                        <div class="to_animate" data-animation="fadeInRight">
                            <div align="center">
                                <img class="img-circle profile_pic" src="<?php echo 'images/couples/' . $user['bride_picture'] . '' ?>">  
                            </div>
                            <div class="text-center">
                                <h3><?php echo $user['bride'] ?></h3>
                                <p><?php echo $user['description_bride'] ?> </p>
                            </div>
                        </div>
                    </div> 
                ...
                <div class="row to_animate" data-animation="fadeInUp">
                    <div class="col-sm-12">
                        <div id="isotope_filters">
                            ...
                            <a href="#" data-filter=".engagment" class="filter_button">
                                <span>Engagment</span>
                                <span></span>
                            </a>
                            <a href="#" data-filter=".jaha" class="filter_button">
                                <span>Jaha/Proposal</span>
                                <span></span>
                            </a>
                            <a href="#" data-filter=".hennah" class="filter_button">
                                <span>Hennah</span>
                                <span></span>
                            </a>
                            <a href="#" data-filter=".preparation" class="filter_button"> 
                            ...
                            <a href="#" data-filter=".honeymoon" class="filter_button"> 
                                <span>Honeymoon</span>
                                <span></span>
                            </a>
...
<section id="invitation_couples" class="bg_fix">
    <div class="container">
        <div class="row to_animate" data-animation="fadeInUp">
            <div class="col-sm-12 text-center">
                <h2 class="section_header">
        ...
        <div class="row">
            <div class="col-sm-4 to_animate" data-animation="fadeInLeft">
                <img class="img-circle" src="images/couples/invit.jpg" alt="">
            </div>
